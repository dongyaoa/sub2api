<template>
  <AppLayout>
    <div class="space-y-6">
      <UsageStatsCards :stats="usageStats" show-cache-rate :show-account-cost="false" :strike-standard-cost="true" />
...
const allColumns = computed<Column[]>(() => [
  ...
  { key: 'cache_rate', label: t('usage.cacheRate'), sortable: false },
