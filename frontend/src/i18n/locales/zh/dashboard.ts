export default {
  ...
  usage: {
    ...
    cacheRateWeightedHint: '按当前筛选范围加权统计',
  ...
  channelStatus: {
    ...
    cards: {
      ...
      endpointLatency: '端点延迟',
      availability: '{days}天可用率',
      timelineLabel: '近 {n} 次记录',
      timelineAria: '最近 {n} 次检测，从左至右由旧到新',
      latestCheck: '最近检测 {time}',
      noChecks: '等待首次检测',
      timeUnknown: '时间未知',
      stale: '数据较旧',
      extraModels: '+{n} 个模型',
    ...
    groups: {
      ...
      anthropic: 'Anthropic',
      other: '其他平台',
      healthSummary: '{normal} 正常 · {abnormal} 异常',
      staleCount: '{count} 数据较旧',
      unknownCount: '{count} 待检测',
    },
    health: {
      operational: '全部运行正常',
      degraded: '部分渠道需关注',
    ...
    toolbar: {
      statisticsPeriod: '可用率统计周期',
      updatedAt: '页面更新于',
      notUpdated: '尚未更新',
      refreshFailed: '更新未完成，当前保留上次成功加载的数据。',
    },
    order: {
      title: '显示排序',
      description: '调整平台分组和组内渠道的显示顺序，保存后对所有用户生效。',
      newItemsHint: '新增渠道会追加到所属分组末尾。停用渠道的排序也会保留。',
      dragGroup: '拖动调整分组顺序',
      dragMonitor: '拖动调整组内顺序',
      moveUp: '上移',
      moveDown: '下移',
      disabled: '已停用',
      save: '保存顺序',
      saving: '正在保存…',
      saved: '显示顺序已保存',
      loadError: '加载显示顺序失败，请重试',
      saveError: '保存显示顺序失败，请重试',
    },
    windowTab: {
      '7d': '7 天',
      '15d': '15 天',
