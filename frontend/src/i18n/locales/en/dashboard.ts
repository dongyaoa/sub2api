export default {
  ...
  usage: {
    ...
    cacheRateWeightedHint: 'Token-weighted across current filters',
  ...
  channelStatus: {
    ...
    cards: {
      ...
      availability: '{days}d uptime',
      timelineLabel: 'HISTORY ({n} PTS)',
      timelineAria: 'Latest {n} checks, oldest to newest from left to right',
      latestCheck: 'Checked {time}',
      noChecks: 'Awaiting first check',
    ...
    groups: {
      ...
      healthSummary: '{normal} healthy · {abnormal} issues',
      staleCount: '{count} stale',
      unknownCount: '{count} awaiting checks',
    },
    health: {
      operational: 'All channels operational',
      degraded: 'Some channels need attention',
      unknown: 'Awaiting check data',
    },
    toolbar: {
      statisticsPeriod: 'Availability period',
      updatedAt: 'Page updated',
      notUpdated: 'Not updated yet',
      refreshFailed: 'The update did not complete. Showing the last successfully loaded data.',
    },
    order: {
      title: 'Display order',
      description: 'Arrange platform groups and the channels within them. The saved order applies to all users.',
      newItemsHint: 'New channels are appended to their group. Disabled channels keep their saved position.',
      dragGroup: 'Drag to reorder this group',
      dragMonitor: 'Drag to reorder within this group',
      moveUp: 'Move up',
      moveDown: 'Move down',
      disabled: 'Disabled',
      save: 'Save order',
      saving: 'Saving…',
      saved: 'Display order saved',
      loadError: 'Failed to load display order. Please retry.',
      saveError: 'Failed to save display order. Please retry.',
    },
    windowTab: {
      '7d': '7 days',
      '15d': '15 days',
