export default {
    accounts: {
      stateTicket: {
  "title": "STATE ticket",
  "description": "Opt in this account only. Off by default; other accounts are unaffected.",
  "enable": "Enable STATE tickets for this account",
  "plan": "Account plan",
  "planPro": "Pro (292)",
  "planTeam": "Team (332)",
  "planHint": "Select the plan manually. Tickets must match the selected length and pass actual model and business route verification. Changing plans requires a new ticket.",
  "globalOff": "The global master switch is off. You can save account settings; harvesting and injection start only after the master switch is enabled.",
  "gatewaySettings": "Open gateway settings",
  "globalPoolConfigured": "Using the global dynamic IP pool: {address}",
  "globalPoolMissing": "Configure the global dynamic IP pool in gateway settings first.",
  "globalPoolHint": "This switch controls tickets for this account. Harvesting uses the global pool; verification and normal requests keep this account's fixed proxy or server direct connection.",
  "directRoute": "This account has no proxy: ticket verification and normal requests connect directly from this server. The dynamic IP pool is used only for harvesting.",
  "proxy": "Harvest proxy",
  "proxyPlaceholder": "Paste the full proxy URL, including username and password",
  "proxyConfigured": "Configured: {address}. Leave blank to keep the existing connection.",
  "proxyHint": "Used only to acquire STATE. Normal requests keep this account’s saved fixed proxy. Tickets are verified before use, valid for about one hour and refreshed before expiry.",
  "sidHint": "Supports HTTP / SOCKS5h proxies. A {'{'}sid{'}'} placeholder in the dynamic proxy username is replaced with a new session ID for each attempt.",
  "model": "Target model: {model}",
  "ready": "Ready, {time} remaining",
  "savedTicket": "Saved ticket",
  "capturedAt": "Captured {time}",
  "expiresAt": "Expires {time}",
  "savedTicketHint": "The ticket survives a service restart. You do not need to copy the original ticket; only these times are shown.",
  "refreshing": "Renewing; the current ticket is still usable, {time} remaining",
  "refreshFailedUsable": "This renewal failed; the current ticket remains in use until it expires.",
  "retryAfter": "Automatic retry after {time}",
  "attempts": "{count} attempts",
  "watchdog": "Dynamic watchdog",
  "watchdogEnabled": "Enabled",
  "watchdogDisabled": "Disabled",
  "watchdogHint": "Automatically reacquires STATE when a business response returns a different model or a STATE of length 312. Length 312 is treated only as an experimental anomaly signal.",
  "watchdogTriggerCount": "Triggered {count} times",
  "watchdogLastReason": "Last trigger: {reason}",
  "watchdogModelMismatch": "Returned model mismatch",
  "watchdogState312": "Length 312 anomaly signal",
  "fixedProxyUnsaved": "The fixed proxy above has unsaved changes. Save the account and reopen this dialog first.",
  "unsaved": "Ticket settings have unsaved changes. Save them before acquiring STATE.",
  "save": "Save ticket settings",
  "acquire": "Acquire now",
  "reacquire": "Reacquire",
  ...
  "loadFailed": "Could not load ticket status. Please retry.",
  "saveFailed": "Save failed. Check the dynamic IP pool, account status and business route settings, then retry.",
  "harvestFailed": "Could not start acquisition. Check the current status and retry.",
  "retry": "Retry",
  "states": {
    "disabled": "Disabled",
    "global_disabled": "Global master switch off",
    "waiting": "Waiting to acquire",
    "harvesting": "Acquiring and verifying",
    "error": "Acquisition failed"
      ...
      openai: {
        ...
        codexTurnTicket: 'STATE ticket',
        codexTurnTicketDesc: 'Ticket status is shown only for opted-in accounts.',
        codexTurnTicketMissing: 'Waiting for STATE',
        codexTurnTicketReady: '{time} left',
        codexTurnTicketPaused: 'Waiting for STATE; target model paused',
      ...
      noProxy: 'No Proxy',
      proxyPool: {
        title: 'Proxy Pool (Optional)',
        hint: 'Set capacity per proxy. Account concurrency is the sum of all entries.',
        add: 'Add Proxy',
        remove: 'Remove Proxy',
        proxy: 'Proxy',
