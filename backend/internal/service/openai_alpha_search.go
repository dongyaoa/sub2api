...
func (s *OpenAIGatewayService) ForwardAlphaSearch(ctx context.Context, c *gin.Context, account *Account, body []byte) (recentResult *OpenAIForwardResult, recentErr error) {
