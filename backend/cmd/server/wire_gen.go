...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	channelMonitorAPIKeyGroupResolver := repository.NewChannelMonitorAPIKeyGroupResolver(client)
	channelMonitorService := service.ProvideChannelMonitorService(channelMonitorRepository, secretEncryptor, settingService, channelMonitorAPIKeyGroupResolver)
	...
	videoTaskStore := repository.ProvideVideoTaskStore(redisClient, db)
	videoTaskService := service.ProvideVideoTaskService(videoTaskStore, imageStorageSettingService)
	...
	checkinService := service.NewCheckinService(client, settingRepository, billingCacheService, apiKeyAuthCacheInvalidator)
	...
	adminUsageHandler := admin.ProvideUsageHandler(usageService, apiKeyService, adminService, usageCleanupService, videoTaskService)
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, grokQuotaService, videoTaskService, configConfig, coordinator)
